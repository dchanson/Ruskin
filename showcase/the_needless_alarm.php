...
$(document).ready(function(){
	...
	if(/Android|BlackBerry|CriOS|IEMobile|iPad|iPhone|iPod|Opera Mini|Opera Mobi|Mobile|Tablet|Touch/i.test(navigator.userAgent)){
		...
		$("#navbar-hand").css({"left":"498px", "top":"30px"});
	}
});
...
<div id="navbar-hand" title="Toggle Hands On/Off">
  ...
  <div id="content">
	<div id="content-left">
		<img id="facs" src="../images/_previews/msi/1229146_preview.jpg" width="100%"/>
		<img id="facs" src="../images/facsimiles/msi/1229146.jpg" width="100%" style="display:none"/>
		<!--<div id="copyright"><img src="..." alt="..." title="Manuscript images &#x00A9;...." width="30" height="60" /></div>-->
	</div>
  	<div id="content-right">
		<div class="witness">
			<?php include("../witnesses/the_needless_alarm_msi.inc.php"); ?>
        </div>
	</div>
  </div>
</div>
