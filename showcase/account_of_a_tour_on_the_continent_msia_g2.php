...
<title>Now Showcasing: Account of a Tour on the Continent (MS IA g2)</title>
...
$(document).ready(function(){			
	$("#first_button, #navbar-facsimile-1, #previous-2").click(function(){		
		...
		$("#facs_preview").attr("src", "../images/_previews/msia_g2/12180625_preview.jpg");	
		$("#facs_preview").show();	
		$("#facs").attr("src", "../images/facsimiles/msia_g2/12180625.jpg");	
		$("#facs").load(function(){	
			$("#facs_preview").hide();
			$("#facs").show();
		});	
...
$(document).ready(function(){			
	$("#navbar-facsimile-1").hover(function(){		
		$("#navbar-facs").show();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/msia_g2/12180625_preview.jpg");	
...
$(document).ready(function(){			
	$("#next-1, #navbar-facsimile-2, #previous-3").click(function(){		
		...
		$("#facs_preview").attr("src", "../images/_previews/msia_g2/12180626_preview.jpg");	
		$("#facs_preview").show();	
		$("#facs").attr("src", "../images/facsimiles/msia_g2/12180626.jpg");	
		$("#facs").load(function(){	
			$("#facs_preview").hide();
			$("#facs").show();
		});	
...
$(document).ready(function(){			
	$("#navbar-facsimile-2").hover(function(){		
		$("#navbar-facs").show();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/msia_g2/12180626_preview.jpg");	
		$("#navbar-facs_preview").show();	
		},function(){	
		$("#navbar-facs").hide();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/blank.jpg");	
...
$(document).ready(function(){			
	$("#next-2, #navbar-facsimile-3, #previous-4").click(function(){		
		...
		$("#facs_preview").attr("src", "../images/_previews/msia_g2/12180627_preview.jpg");	
		$("#facs_preview").show();	
		$("#facs").attr("src", "../images/facsimiles/msia_g2/12180627.jpg");	
		$("#facs").load(function(){	
			$("#facs_preview").hide();
			$("#facs").show();
		});	
...
$(document).ready(function(){			
	$("#navbar-facsimile-3").hover(function(){		
		$("#navbar-facs").show();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/msia_g2/12180627_preview.jpg");	
		$("#navbar-facs_preview").show();	
		},function(){	
		$("#navbar-facs").hide();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/blank.jpg");	
...
// Select Facsimile 4 //			
$(document).ready(function(){			
	$("#next-3, #navbar-facsimile-4, #last_button").click(function(){		
		$(".shortcut").css("color", "#FFF");	
...
<div id="navbar-hand" title="Toggle Hands On/Off">
  ...
  <div id="content">
	<div id="content-left">
        <img id="facs_preview" src="../images/_previews/msia_g2/12180625_preview.jpg" width="100%"/>
        <img id="facs" src="../images/facsimiles/msia_g2/12180625.jpg" width="100%" style="display:none"/>
		<!--<div id="copyright"><img src="..." alt="..." title="Manuscript images &#x00A9;...." width="30" height="60" /></div>-->
	</div>
  	<div id="content-right">
		<div class="witness">
			<?php include("../witnesses/calais_prose_msia_g2.inc.php"); ?>
			<?php include("../witnesses/passing_the_alps_poem_msia_g2.inc.php"); ?>
			<?php include("../witnesses/milan_cathedral_poem_msia_g2.inc.php"); ?>
			<?php include("../witnesses/andernacht_poem_msia_g2.inc.php"); ?>
