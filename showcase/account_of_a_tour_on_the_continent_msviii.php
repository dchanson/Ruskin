...
<title>Now Showcasing: Account of a Tour on the Continent (MS VIII)</title>
...
$(document).ready(function(){			
	$("#first_button, #navbar-facsimile-1, #previous-2").click(function(){		
		...
		$("#facs_preview").attr("src", "../images/_previews/msviii/MSVIIIp52-53_preview.jpg");	
		$("#facs_preview").show();	
		$("#facs").attr("src", "../images/facsimiles/msviii/MSVIIIp52-53.jpg");	
		$("#facs").load(function(){	
			$("#facs_preview").hide();
			$("#facs").show();
		});	
...
$(document).ready(function(){			
	$("#navbar-facsimile-1").hover(function(){		
		$("#navbar-facs").show();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/msviii/MSVIIIp52-53_preview.jpg");	
...
// Select Facsimile 2 //			
$(document).ready(function(){			
	$("#next-1, #navbar-facsimile-2, #previous-3").click(function(){		
		$(".shortcut").css("color", "#FFF");	
		$("#navbar-facsimile-2").css("color", "#09C");	
		$(".navbar-navigation").hide();	
		$("#navbar-navigation-2").show();	
		$("#facs_preview").attr("src", "../images/_previews/msviii/MSVIIIp54-55_preview.jpg");	
		$("#facs_preview").show();	
		$("#facs").attr("src", "../images/facsimiles/msviii/MSVIIIp54-55.jpg");	
		$("#facs").load(function(){	
			$("#facs_preview").hide();
			$("#facs").show();
		});	
...
$(document).ready(function(){			
	$("#navbar-facsimile-2").hover(function(){		
		$("#navbar-facs").show();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/msviii/MSVIIIp54-55_preview.jpg");	
		$("#navbar-facs_preview").show();	
		},function(){	
		$("#navbar-facs").hide();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/blank.jpg");	
...
// Select Facsimile 3 //			
$(document).ready(function(){			
	$("#next-2, #navbar-facsimile-3, #previous-4").click(function(){		
		$(".shortcut").css("color", "#FFF");	
		$("#navbar-facsimile-3").css("color", "#09C");	
		$(".navbar-navigation").hide();	
		$("#navbar-navigation-3").show();	
		$("#facs_preview").attr("src", "../images/_previews/msviii/MSVIII55v-56r_preview.jpg");	
		$("#facs_preview").show();	
		$("#facs").attr("src", "../images/facsimiles/msviii/MSVIII55v-56r.jpg");	
		$("#facs").load(function(){	
			$("#facs_preview").hide();
			$("#facs").show();
		});	
...
// Preview Facsimile 3 //			
$(document).ready(function(){			
	$("#navbar-facsimile-3").hover(function(){		
		$("#navbar-facs").show();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/msviii/MSVIII55v-56r_preview.jpg");	
		$("#navbar-facs_preview").show();	
		},function(){	
		$("#navbar-facs").hide();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/blank.jpg");	
...
// Select Facsimile 4 //			
$(document).ready(function(){			
	$("#next-3, #navbar-facsimile-4, #previous-5").click(function(){		
		$(".shortcut").css("color", "#FFF");	
		$("#navbar-facsimile-4").css("color", "#09C");	
		$(".navbar-navigation").hide();	
		$("#navbar-navigation-4").show();	
		$("#facs_preview").attr("src", "../images/_previews/msviii/MSVIII56v-57r_preview.jpg");	
		$("#facs_preview").show();	
		$("#facs").attr("src", "../images/facsimiles/msviii/MSVIII56v-57r.jpg");	
		$("#facs").load(function(){	
			$("#facs_preview").hide();
			$("#facs").show();
		});	
...
// Preview Facsimile 4 //			
$(document).ready(function(){			
	$("#navbar-facsimile-4").hover(function(){		
		$("#navbar-facs").show();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/msviii/MSVIII56v-57r_preview.jpg");	
		$("#navbar-facs_preview").show();	
		},function(){	
		$("#navbar-facs").hide();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/blank.jpg");	
...
// Select Facsimile 5 //			
$(document).ready(function(){			
	$("#next-4, #navbar-facsimile-5, #previous-6").click(function(){		
		$(".shortcut").css("color", "#FFF");	
		$("#navbar-facsimile-5").css("color", "#09C");	
		$(".navbar-navigation").hide();	
		$("#navbar-navigation-5").show();	
		$("#facs_preview").attr("src", "../images/_previews/msviii/MSVIII57v-58r_preview.jpg");	
		$("#facs_preview").show();	
		$("#facs").attr("src", "../images/facsimiles/msviii/MSVIII57v-58r.jpg");	
		$("#facs").load(function(){	
			$("#facs_preview").hide();
			$("#facs").show();
		});	
...
// Preview Facsimile 5 //			
$(document).ready(function(){			
	$("#navbar-facsimile-5").hover(function(){		
		$("#navbar-facs").show();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/msviii/MSVIII57v-58r_preview.jpg");	
		$("#navbar-facs_preview").show();	
		},function(){	
		$("#navbar-facs").hide();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/blank.jpg");	
...
// Select Facsimile 6 //			
$(document).ready(function(){			
	$("#next-5, #navbar-facsimile-6, #previous-7").click(function(){		
		$(".shortcut").css("color", "#FFF");	
		$("#navbar-facsimile-6").css("color", "#09C");	
		$(".navbar-navigation").hide();	
		$("#navbar-navigation-6").show();	
		$("#facs_preview").attr("src", "../images/_previews/msviii/MSVIII58v-59r_preview.jpg");	
		$("#facs_preview").show();	
		$("#facs").attr("src", "../images/facsimiles/msviii/MSVIII58v-59r.jpg");	
		$("#facs").load(function(){	
			$("#facs_preview").hide();
			$("#facs").show();
		});	
...
// Preview Facsimile 6 //			
$(document).ready(function(){			
	$("#navbar-facsimile-6").hover(function(){		
		$("#navbar-facs").show();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/msviii/MSVIII58v-59r_preview.jpg");	
		$("#navbar-facs_preview").show();	
		},function(){	
		$("#navbar-facs").hide();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/blank.jpg");	
...
// Select Facsimile 7 //			
$(document).ready(function(){			
	$("#next-6, #navbar-facsimile-7, #previous-8").click(function(){		
		$(".shortcut").css("color", "#FFF");	
		$("#navbar-facsimile-7").css("color", "#09C");	
		$(".navbar-navigation").hide();	
		$("#navbar-navigation-7").show();	
		$("#facs_preview").attr("src", "../images/_previews/msviii/MSVIII59v-60r_preview.jpg");	
		$("#facs_preview").show();	
		$("#facs").attr("src", "../images/facsimiles/msviii/MSVIII59v-60r.jpg");	
		$("#facs").load(function(){	
			$("#facs_preview").hide();
			$("#facs").show();
		});	
...
// Preview Facsimile 7 //			
$(document).ready(function(){			
	$("#navbar-facsimile-7").hover(function(){		
		$("#navbar-facs").show();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/msviii/MSVIII59v-60r_preview.jpg");	
		$("#navbar-facs_preview").show();	
		},function(){	
		$("#navbar-facs").hide();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/blank.jpg");	
...
// Select Facsimile 8 //			
$(document).ready(function(){			
	$("#next-7, #navbar-facsimile-8, #previous-9").click(function(){		
		$(".shortcut").css("color", "#FFF");	
		$("#navbar-facsimile-8").css("color", "#09C");	
		$(".navbar-navigation").hide();	
		$("#navbar-navigation-8").show();	
		$("#facs_preview").attr("src", "../images/_previews/msviii/MSVIII60v-61r_preview.jpg");	
		$("#facs_preview").show();	
		$("#facs").attr("src", "../images/facsimiles/msviii/MSVIII60v-61r.jpg");	
		$("#facs").load(function(){	
			$("#facs_preview").hide();
			$("#facs").show();
		});	
...
// Preview Facsimile 8 //			
$(document).ready(function(){			
	$("#navbar-facsimile-8").hover(function(){		
		$("#navbar-facs").show();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/msviii/MSVIII60v-61r_preview.jpg");	
		$("#navbar-facs_preview").show();	
		},function(){	
		$("#navbar-facs").hide();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/blank.jpg");	
...
// Select Facsimile 9 //			
$(document).ready(function(){			
	$("#next-8, #navbar-facsimile-9, #previous-10").click(function(){		
		$(".shortcut").css("color", "#FFF");	
		$("#navbar-facsimile-9").css("color", "#09C");	
		$(".navbar-navigation").hide();	
		$("#navbar-navigation-9").show();	
		$("#facs_preview").attr("src", "../images/_previews/msviii/MSVIII61v-62r_preview.jpg");	
		$("#facs_preview").show();	
		$("#facs").attr("src", "../images/facsimiles/msviii/MSVIII61v-62r.jpg");	
		$("#facs").load(function(){	
			$("#facs_preview").hide();
			$("#facs").show();
		});	
...
// Preview Facsimile 9 //			
$(document).ready(function(){			
	$("#navbar-facsimile-9").hover(function(){		
		$("#navbar-facs").show();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/msviii/MSVIII61v-62r_preview.jpg");	
		$("#navbar-facs_preview").show();	
		},function(){	
		$("#navbar-facs").hide();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/blank.jpg");	
...
// Select Facsimile 10 //			
$(document).ready(function(){			
	$("#next-9, #navbar-facsimile-10, #previous-11").click(function(){		
		$(".shortcut").css("color", "#FFF");	
		$("#navbar-facsimile-10").css("color", "#09C");	
		$(".navbar-navigation").hide();	
		$("#navbar-navigation-10").show();	
		$("#facs_preview").attr("src", "../images/_previews/msviii/MSVIII62v-63r_preview.jpg");	
		$("#facs_preview").show();	
		$("#facs").attr("src", "../images/facsimiles/msviii/MSVIII62v-63r.jpg");	
		$("#facs").load(function(){	
			$("#facs_preview").hide();
			$("#facs").show();
		});	
...
// Preview Facsimile 10 //			
$(document).ready(function(){			
	$("#navbar-facsimile-10").hover(function(){		
		$("#navbar-facs").show();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/msviii/MSVIII62v-63r_preview.jpg");	
		$("#navbar-facs_preview").show();	
		},function(){	
		$("#navbar-facs").hide();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/blank.jpg");	
...
// Select Facsimile 11 //			
$(document).ready(function(){			
	$("#next-10, #navbar-facsimile-11, #last_button").click(function(){		
		$(".shortcut").css("color", "#FFF");	
		$("#navbar-facsimile-11").css("color", "#09C");	
		$(".navbar-navigation").hide();	
		$("#navbar-navigation-11").show();	
		$("#facs_preview").attr("src", "../images/_previews/msviii/MSVIII63v-64r_preview.jpg");	
		$("#facs_preview").show();	
		$("#facs").attr("src", "../images/facsimiles/msviii/MSVIII63v-64r.jpg");	
		$("#facs").load(function(){	
			$("#facs_preview").hide();
			$("#facs").show();
		});	
...
// Preview Facsimile 11 //			
$(document).ready(function(){			
	$("#navbar-facsimile-11").hover(function(){		
		$("#navbar-facs").show();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/msviii/MSVIII63v-64r_preview.jpg");	
		$("#navbar-facs_preview").show();	
		},function(){	
		$("#navbar-facs").hide();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/blank.jpg");	
...
<div id="main">
  ...
  <div id="navbar">
	...
	<div id="navbar-navigation-3" class="navbar-navigation" style="display:none">	
	<img id="previous-3" class="previous_button" src="images/navbar/previous.jpg" alt="Previous Facsmilie Button" title="Go to the Previous Facsimile" width="26" height="20"/><div class="navbar-location" title="Select a Facsimile">f3</div><img id="next-3" class="next_button" src="images/navbar/next.jpg" alt="Next Facsimile Button" title="Go to the Next Facsimile" width="26" height="20"/>
	</div>	
	<div id="navbar-navigation-4" class="navbar-navigation" style="display:none">	
	<img id="previous-4" class="previous_button" src="images/navbar/previous.jpg" alt="Previous Facsmilie Button" title="Go to the Previous Facsimile" width="26" height="20"/><div class="navbar-location" title="Select a Facsimile">f4</div><img id="next-4" class="next_button" src="images/navbar/next.jpg" alt="Next Facsimile Button" title="Go to the Next Facsimile" width="26" height="20"/>
	</div>	
	<div id="navbar-navigation-5" class="navbar-navigation" style="display:none">	
	<img id="previous-5" class="previous_button" src="images/navbar/previous.jpg" alt="Previous Facsmilie Button" title="Go to the Previous Facsimile" width="26" height="20"/><div class="navbar-location" title="Select a Facsimile">f5</div><img id="next-5" class="next_button" src="images/navbar/next.jpg" alt="Next Facsimile Button" title="Go to the Next Facsimile" width="26" height="20"/>
	</div>	
	<div id="navbar-navigation-6" class="navbar-navigation" style="display:none">	
	<img id="previous-6" class="previous_button" src="images/navbar/previous.jpg" alt="Previous Facsmilie Button" title="Go to the Previous Facsimile" width="26" height="20"/><div class="navbar-location" title="Select a Facsimile">f6</div><img id="next-6" class="next_button" src="images/navbar/next.jpg" alt="Next Facsimile Button" title="Go to the Next Facsimile" width="26" height="20"/>
	</div>	
	<div id="navbar-navigation-7" class="navbar-navigation" style="display:none">	
	<img id="previous-7" class="previous_button" src="images/navbar/previous.jpg" alt="Previous Facsmilie Button" title="Go to the Previous Facsimile" width="26" height="20"/><div class="navbar-location" title="Select a Facsimile">f7</div><img id="next-7" class="next_button" src="images/navbar/next.jpg" alt="Next Facsimile Button" title="Go to the Next Facsimile" width="26" height="20"/>
	</div>	
	<div id="navbar-navigation-8" class="navbar-navigation" style="display:none">	
	<img id="previous-8" class="previous_button" src="images/navbar/previous.jpg" alt="Previous Facsmilie Button" title="Go to the Previous Facsimile" width="26" height="20"/><div class="navbar-location" title="Select a Facsimile">f8</div><img id="next-8" class="next_button" src="images/navbar/next.jpg" alt="Next Facsimile Button" title="Go to the Next Facsimile" width="26" height="20"/>
	</div>
	<div id="navbar-navigation-9" class="navbar-navigation" style="display:none">	
	<img id="previous-9" class="previous_button" src="images/navbar/previous.jpg" alt="Previous Facsmilie Button" title="Go to the Previous Facsimile" width="26" height="20"/><div class="navbar-location" title="Select a Facsimile">f9</div><img id="next-9" class="next_button" src="images/navbar/next.jpg" alt="Next Facsimile Button" title="Go to the Next Facsimile" width="26" height="20"/>
	</div>	
	<div id="navbar-navigation-10" class="navbar-navigation" style="display:none">	
	<img id="previous-10" class="previous_button" src="images/navbar/previous.jpg" alt="Previous Facsmilie Button" title="Go to the Previous Facsimile" width="26" height="20"/><div class="navbar-location" title="Select a Facsimile">f10</div><img id="next-10" class="next_button" src="images/navbar/next.jpg" alt="Next Facsimile Button" title="Go to the Next Facsimile" width="26" height="20"/>
	</div>	
	<div id="navbar-navigation-11" class="navbar-navigation" style="display:none">	
	<img id="previous-11" class="previous_button" src="images/navbar/previous.jpg" alt="Previous Facsmilie Button" title="Go to the Previous Facsimile" width="26" height="20"/><div class="navbar-location" title="Select a Facsimile">f11</div><img id="next-11" class="next_button" src="images/navbar/next.jpg" alt="Next Facsimile Button" title="Go to the Next Facsimile" width="26" height="20"/>
	</div>	
<img id="last_button" src="images/navbar/last.jpg" alt="Last Facsimile Button" title="Go to the Last Facsimile" width="26" height="20" /><img id="toggle-view" src="images/navbar/facsimile-transcription_ro.jpg" alt="Toggle Views Button" title="Toggle Views" width="26" height="20" /><img id="toggle-magnify" src="images/navbar/magnify_ro.jpg" alt="Magnification Button" title="Increase the Magnification of the Facsimile" width="26" height="20" /><img id="toggle-enlarge" src="images/navbar/enlarge_ro.jpg" alt="Point Size Button" title="Increase the Point Size of the Transcription" width="26" height="20" /><img id="toggle-transcription" src="images/navbar/text-composite.jpg" alt="Transcription Button" title="Toggle Transcriptions" width="26" height="20" /><img id="toggle-hand" src="images/navbar/scribe_ro.jpg" alt="Hands Button" title="Toggle Hands On/Off" width="26" height="20" /><img id="toggle-info" src="images/navbar/info.jpg" alt="Info Button" title="Learn about Showcase" width="26" height="20" style="float:right" /><img id="toggle-info_ro" src="images/navbar/info_ro.jpg" alt="Info Button" title="Learn about Showcase" width="26" height="20" style="display:none; float:right" />
	<div id="navbar-facsimile" title="Select a Facsimile">
    	<span class="navbar-facsimile-text">Facsimile:
            ...
            <br/>
            <br/><div id="navbar-facsimile-3" class="shortcut">f3</div>
            <br/>
            <br/><div id="navbar-facsimile-4" class="shortcut">f4</div>
            <br/>
            <br/><div id="navbar-facsimile-5" class="shortcut">f5</div>
            <br/>
            <br/><div id="navbar-facsimile-6" class="shortcut">f6</div>
            <br/>
            <br/><div id="navbar-facsimile-7" class="shortcut">f7</div>
            <br/>
            <br/><div id="navbar-facsimile-8" class="shortcut">f8</div>
            <br/>
            <br/><div id="navbar-facsimile-9" class="shortcut">f9</div>
            <br/>
            <br/><div id="navbar-facsimile-10" class="shortcut">f10</div>
            <br/>
            <br/><div id="navbar-facsimile-11" class="shortcut">f11</div>
            <br/>
			<br/>
            <br/>
        </span>
...
<div id="navbar-hand" title="Toggle Hands On/Off">
  ...
  <div id="content">
	<div id="content-left">
        <img id="facs_preview" src="../images/_previews/msviii/MSVIIIp52-53_preview.jpg" width="100%"/>
        <img id="facs" src="../images/facsimiles/msviii/MSVIIIp52-53.jpg" width="100%" style="display:none"/>
		<!--<div id="copyright"><img src="..." alt="..." title="Manuscript images &#x00A9;...." width="30" height="60" /></div>-->
	</div>
  	<div id="content-right">
		<div class="witness">
			<?php include("../witnesses/oh_are_there_spirits_can_there_be_poem_msviii.inc.php"); ?>
			<?php include("../witnesses/source_of_the_arveron_prose_msviii.inc.php"); ?>
			<?php include("../witnesses/i_woke_to_hear_the_lullaby_poem_msviii.inc.php"); ?>
			<?php include("../witnesses/andernacht_prose_msviii.inc.php"); ?>
			<?php include("../witnesses/st_goar_prose_msviii.inc.php"); ?>
			<?php include("../witnesses/there_is_a_charmed_peace_that_aye_poem_msviii.inc.php"); ?>
			<?php include("../witnesses/via_mala_poem_msviii.inc.php"); ?>
			<?php include("../witnesses/splugen_poem_msviii.inc.php"); ?>
			<?php include("../witnesses/the_summit_poem_msviii.inc.php"); ?>
			<?php include("../witnesses/the_descent_poem_msviii.inc.php"); ?>
			<?php include("../witnesses/the_meuse_prose_msviii.inc.php"); ?>
			<?php include("../witnesses/cologne_prose_msviii.inc.php"); ?>
			<?php include("../witnesses/oh_the_morn_looked_bright_on_hill_and_dale_poem_msviii.inc.php"); ?>
			<?php include("../witnesses/it_was_a_wide_and_stretchy_sweep_prose_msviii.inc.php"); ?>
			<?php include("../witnesses/part_of_brussels_prose1_msviii.inc.php"); ?>
			<?php include("../witnesses/oh_softly_blew_the_morning_breeze_poem_msviii.inc.php"); ?>
			<?php include("../witnesses/part_of_brussels_prose2_msviii.inc.php"); ?>
