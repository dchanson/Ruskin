   ...
   <div class="witness">
      <div class="poem" id="">
         ...
         <div class="lg-stanza">
            ...
            <span class="l">The clouds which round  new="" script="print" >his glories met</span><br/>
          ...
          class="s-subst s-add s-overwrite s-inline">at</div> <span class="del-strikethrough">noble sun have</span> <div 
              class="add-above" 
              style="left:2.4em">orb of light</div>do take your ground</span><br/>
