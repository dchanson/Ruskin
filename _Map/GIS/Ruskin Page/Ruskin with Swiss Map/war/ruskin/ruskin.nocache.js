function ruskin() {
    var O = 'bootstrap',
        ...
        _b = 'ruskin.devmode.js',
        ac = '1A7EF18B8F6E4D7E0B716936025211B3',
        bc = '4149E110CC8F3939E72BBFEAB7C350B5',
        cc = '8B2A2CF1259CB8474F057F4CC342024A',
        dc = 'A419B159DD86590B47F533069318780E',
        ec = 'F1D2AD9A6A5C5BE006BF5F6DF0C8055E',
        fc = ':',
        gc = '.cache.js',
        hc = 'link',
        ic = 'rel',
    ...
    ruskin.__sendStats = r;
    ruskin.__moduleName = S;
    ruskin.__errFn = null;
    ruskin.__moduleBase = U;
    ruskin.__softPermutationId = V;
    ruskin.__computePropValue = null;
    ruskin.__getPropMap = null;
    ruskin.__installRunAsyncCode = function() {};
    ruskin.__gwtStartLoadingFragment = function() {
        return null
    };
    ruskin.__gwt_isKnownPropertyValue = function() {
        return false
    };
    ruskin.__gwt_getMetaProperty = function() {
        return null
    };
    var s = null;
    ...
    ruskin.__moduleStartupDone = function(e) {
        var f = t[S].bindings;
        t[S].bindings = function() {
            var a = f ? f() : {};
            var b = e[ruskin.__softPermutationId];
    ...
    function A(k) {
        ...
        ruskin.onScriptDownloaded = function(a) {
            l(function() {
                m(a)
            })
        };
        ...
        if (ruskin.__errFn) {
            n.onerror = function() {
                ruskin.__errFn(S, new Error(nb + code))
            }
        }
        p.getElementsByTagName(ob)[V].appendChild(n)
    }
    ruskin.__startLoadingFragment = function(a) {
        return D(a)
    };
    ruskin.__installRunAsyncCode = function(a) {
        var b = v();
        var c = b.body;
    ...
    function F() {
        ...
        ruskin.__computePropValue = k;
        o.__gwt_activeModules[S].bindings = ruskin.__getPropMap;
        r(O, $b);
        if (q()) {
            return D(_b)
        }
    ...
    B();
    ruskin.__moduleBase = C();
    t[S].moduleBase = ruskin.__moduleBase;
    var H = F();
    if (o) {
