   ...
   <div class="witness">
      <div class="poem" id="">
         ...
         <div class="lg-stanza">
            ...
            <span class="l">Broad loom<span class="overwriting">ed</span> the lofty city in its sleep</span><br/>
          ...
          class="s-subst s-add s-overwrite s-inline">rose</div> <span class="placeName-building-SALZBURGCATHEDRAL"><span class="persName-STRUPERT">St Rupert</span>s mighty marble shrine</span></span><br/>
            ...
            <span class="l">Crag <span class="del-strikethrough">heaped</span> poised on crag, with each its battlement</span><br/>
            <span class="l"><div 
          class="subst-del s-subst s-del" >That</div><div 
          class="s-subst s-add s-overwrite s-inline">The</div> <span class="placeName-HOHENSALZBURG">Fortress</span> reared its dark and huge ascent<span class="gloss-inline">
          ...
          System generated line number
            ...
            <span class="l"><span class="del-strikethrough">Loud shouts</span> <div class="add-margin-left"><span class="space" style="padding-left:-1.2em"> </span>Low chaunts</div><span class="add-overwriting">Low chaunts</span> the fisher where the waters pour,</span><br/><span class="space" style="padding-left:-1.2em"> </span>
