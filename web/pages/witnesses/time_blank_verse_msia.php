...
MSIAsheet4.jpg msia/MSIAsheet2.jpg msia/MSIAsheet3.jpg
EOT
);
      ?>
...
<div xmlns:tei="http://www.tei-c.org/ns/1.0" xmlns:xi="http://www.w3.org/2001/XInclude" xmlns:teix="http://www.tei-c.org/ns/Examples" xmlns:custom="http://whatever" id="content-right">
   ...
   <div class="witness">
      <div class="poem" id="">
         ...
         <div class="lg-stanza">
            <span class="l"><span class="caps">P</span><span class="smallcaps">apa</span> whats time a figure or a sense</span><br/>
            <span class="l">Tis one but not the other.<span class="gloss-inline">
          <a href="https://erm.selu.edu/glosses/time_blank_verse_glosses_contextual#BASELINEPUNCTUATIONGLOSS" target="_blank" class="inactive">
              ...
              </a></span> Is not time</span><br/>
            <span class="l">a figure es it is for on the tops of shops</span><br/>
          ...
          class="s-subst s-add s-overwrite s-inline">tis but an hour to merry <span class="date-1827-01-01">ew ears ay</span></div></span><br/>
            <span class="l">for though it is a day a days an hour
               <div class="s-line-number s-line-number-auto">
                  <div class="tooltip">
          System generated line number
        </div><a href="#L30" id="L30">30</a></div></span><br/>
            <span class="l">and whats an hour tis only a wee minute</span><br/>
