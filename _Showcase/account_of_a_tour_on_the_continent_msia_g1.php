...
<title>Now Showcasing: Account of a Tour on the Continent (MS IA g1)</title>
...
$(document).ready(function(){			
	$("#first_button, #navbar-facsimile-1, #previous-2").click(function(){		
		...
		$("#facs_preview").attr("src", "../images/_previews/msia/MSIAsheet20_preview.jpg");	
		$("#facs_preview").show();	
		$("#facs").attr("src", "../images/facsimiles/msia/MSIAsheet20.jpg");	
		$("#facs").load(function(){	
			$("#facs_preview").hide();
			$("#facs").show();
		});	
...
$(document).ready(function(){			
	$("#navbar-facsimile-1").hover(function(){		
		$("#navbar-facs").show();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/msia/MSIAsheet20_preview.jpg");	
...
$(document).ready(function(){			
	$("#next-1, #navbar-facsimile-2, #previous-3").click(function(){		
		...
		$("#facs_preview").attr("src", "../images/_previews/msia/MSIAsheet21_preview.jpg");	
		$("#facs_preview").show();	
		$("#facs").attr("src", "../images/facsimiles/msia/MSIAsheet21.jpg");	
		$("#facs").load(function(){	
			$("#facs_preview").hide();
			$("#facs").show();
		});	
...
$(document).ready(function(){			
	$("#navbar-facsimile-2").hover(function(){		
		$("#navbar-facs").show();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/msia/MSIAsheet21_preview.jpg");	
		$("#navbar-facs_preview").show();	
		},function(){	
		$("#navbar-facs").hide();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/blank.jpg");	
...
$(document).ready(function(){			
	$("#next-2, #navbar-facsimile-3, #previous-4").click(function(){		
		...
		$("#facs_preview").attr("src", "../images/_previews/msia/1038179_preview.jpg");	
		$("#facs_preview").show();	
		$("#facs").attr("src", "../images/facsimiles/msia/1038179.jpg");	
		$("#facs").load(function(){	
			$("#facs_preview").hide();
			$("#facs").show();
		});	
...
$(document).ready(function(){			
	$("#navbar-facsimile-3").hover(function(){		
		$("#navbar-facs").show();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/msia/1038179_preview.jpg");	
		$("#navbar-facs_preview").show();	
		},function(){	
		$("#navbar-facs").hide();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/blank.jpg");	
...
$(document).ready(function(){			
	$("#next-3, #navbar-facsimile-4, #previous-5").click(function(){		
		...
		$("#facs_preview").attr("src", "../images/_previews/msia/MSIASheet24_preview.jpg");	
		$("#facs_preview").show();	
		$("#facs").attr("src", "../images/facsimiles/msia/MSIASheet24.jpg");	
		$("#facs").load(function(){	
			$("#facs_preview").hide();
			$("#facs").show();
		});	
...
$(document).ready(function(){			
	$("#navbar-facsimile-4").hover(function(){		
		$("#navbar-facs").show();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/msia/MSIASheet24_preview.jpg");	
		$("#navbar-facs_preview").show();	
		},function(){	
		$("#navbar-facs").hide();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/blank.jpg");	
...
// Select Facsimile 5 //			
$(document).ready(function(){			
	$("#next-4, #navbar-facsimile-5, #last_button").click(function(){		
		$(".shortcut").css("color", "#FFF");	
		$("#navbar-facsimile-5").css("color", "#09C");	
		$(".navbar-navigation").hide();	
		$("#navbar-navigation-5").show();	
		$("#facs_preview").attr("src", "../images/_previews/msia/1038179b_preview.jpg");	
		$("#facs_preview").show();	
		$("#facs").attr("src", "../images/facsimiles/msia/1038179b.jpg");	
		$("#facs").load(function(){	
			$("#facs_preview").hide();
			$("#facs").show();
		});	
...
$(document).ready(function(){			
	$("#navbar-facsimile-5").hover(function(){		
		$("#navbar-facs").show();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/msia/1038179b_preview.jpg");	
		$("#navbar-facs_preview").show();	
		},function(){	
		$("#navbar-facs").hide();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/blank.jpg");	
  ...
  <div id="content">
	<div id="content-left">
  	...
  	<div id="content-right">
		<div class="witness">
			<?php include("../witnesses/calais_poem_msia_g1.inc.php"); ?>
			<?php include("../witnesses/cassel_poem_msia_g1.inc.php"); ?>
			<?php include("../witnesses/lille_poem_msia_g1.inc.php"); ?>
			<?php include("../witnesses/brussels_poem_msia_g1.inc.php"); ?>
			<?php include("../witnesses/the_meuse_poem_msia_g1.inc.php"); ?>
        </div>
	</div>
  </div>
</div>
