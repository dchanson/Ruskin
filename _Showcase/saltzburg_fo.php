...
<title>Now Showcasing: "Saltzburg" (Friendship's Offering)</title>
...
$(document).ready(function(){			
	$("#first_button, #navbar-facsimile-1, #previous-2").click(function(){		
		...
		$("#facs_preview").attr("src", "../images/_previews/fo/saltzburg_1_preview.jpg");	
		$("#facs_preview").show();	
		$("#facs").attr("src", "../images/facsimiles/fo/saltzburg_1.jpg");	
		$("#facs").load(function(){	
			$("#facs_preview").hide();
			$("#facs").show();
		});	
...
$(document).ready(function(){			
	$("#navbar-facsimile-1").hover(function(){		
		$("#navbar-facs").show();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/fo/saltzburg_1_preview.jpg");	
...
// Select Facsimile 2 //			
$(document).ready(function(){			
	$("#next-1, #navbar-facsimile-2, #previous_3").click(function(){		
		$(".shortcut").css("color", "#FFF");	
		$("#navbar-facsimile-2").css("color", "#09C");	
		$(".navbar-navigation").hide();	
		$("#navbar-navigation-2").show();	
		$("#facs_preview").attr("src", "../images/_previews/fo/saltzburg_2_preview.jpg");	
		$("#facs_preview").show();	
		$("#facs").attr("src", "../images/facsimiles/fo/saltzburg_2.jpg");	
		$("#facs").load(function(){	
			$("#facs_preview").hide();
			$("#facs").show();
		});	
...
$(document).ready(function(){			
	$("#navbar-facsimile-2").hover(function(){		
		$("#navbar-facs").show();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/fo/saltzburg_2_preview.jpg");	
		$("#navbar-facs_preview").show();	
		},function(){	
		$("#navbar-facs").hide();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/blank.jpg");	
...
// Select Facsimile 3 //			
$(document).ready(function(){			
	$("#next-2, #navbar-facsimile-3, #last_button").click(function(){		
		$(".shortcut").css("color", "#FFF");	
		$("#navbar-facsimile-2").css("color", "#09C");	
		$(".navbar-navigation").hide();	
		$("#navbar-navigation-2").show();	
		$("#facs_preview").attr("src", "../images/_previews/fo/saltzburg_3_preview.jpg");	
		$("#facs_preview").show();	
		$("#facs").attr("src", "../images/facsimiles/fo/saltzburg_3.jpg");	
		$("#facs").load(function(){	
			$("#facs_preview").hide();
			$("#facs").show();
		});	
...
$(document).ready(function(){			
	$("#navbar-facsimile-3").hover(function(){		
		$("#navbar-facs").show();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/fo/saltzburg_3_preview.jpg");	
		$("#navbar-facs_preview").show();	
		},function(){	
		$("#navbar-facs").hide();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/blank.jpg");	
...
<div id="navbar-hand" title="Toggle Hands On/Off">
  ...
  <div id="content">
	<div id="content-left">
        <img id="facs_preview" src="../images/_previews/fo/saltzburg_1_preview.jpg" width="100%"/>
        <img id="facs" src="../images/facsimiles/fo/saltzburg_1.jpg" width="100%" style="display:none"/>
		<!--<div id="copyright"><img src="..." alt="..." title="Manuscript images &#x00A9;...." width="30" height="60" /></div>-->
	</div>
  	<div id="content-right">
		<div class="witness">
			<?php include("../witnesses/saltzburg_fo.inc.php"); ?>
        </div>
	</div>
  </div>
</div>
