...
<title>Now Showcasing: "Spring: Blank Verse" (Houghton)</title>
...
<div id="navbar-hand" title="Toggle Hands On/Off">
  ...
  <div id="content">
	<div id="content-left">
        <img id="facs_preview" src="../images/_previews/houghton/modbm_ms_am_1088_5955_0004_preview.jpg" width="100%"/>
        <img id="facs" src="../images/facsimiles/houghton/modbm_ms_am_1088_5955_0004.jpg" width="100%" style="display:none"/>
		<!--<div id="copyright"><img src="..." alt="..." title="Manuscript images &#x00A9;...." width="30" height="60" /></div>-->
	</div>
  	<div id="content-right">
		<div class="witness">
			<?php include("../witnesses/spring_blank_verse_houghton.inc.php"); ?>
        </div>
	</div>
  </div>
</div>
