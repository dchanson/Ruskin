...
<title>Now Showcasing: "The Ship" and "Look at That Ship" [1827] (MS IIII)</title>
...
$(document).ready(function(){			
	$("#first_button, #navbar-facsimile-1, #previous-2").click(function(){		
		...
		$("#facs_preview").attr("src", "../images/_previews/msiii/1229169_preview.jpg");	
		$("#facs_preview").show();	
		$("#facs").attr("src", "../images/facsimiles/msiii/1229169.jpg");	
		$("#facs").load(function(){	
			$("#facs_preview").hide();
			$("#facs").show();
		});	
...
$(document).ready(function(){			
	$("#navbar-facsimile-1").hover(function(){		
		$("#navbar-facs").show();	
		$("#navbar-facs_preview").attr("src", "../images/_previews/msiii/1229169_preview.jpg");	
...
<div id="navbar-hand" title="Toggle Hands On/Off">
  ...
  <div id="content">
	<div id="content-left">
        <img id="facs_preview" src="../images/_previews/msiii/1229169_preview.jpg" width="100%"/>
        <img id="facs" src="../images/facsimiles/msiii/1229169.jpg" width="100%" style="display:none"/>
		<!--<div id="copyright"><img src="..." alt="..." title="Manuscript images &#x00A9;...." width="30" height="60" /></div>-->
	</div>
  	<div id="content-right">
		<div class="witness">
			<?php include("../witnesses/look_at_that_ship_msiii.inc.php"); ?>
        </div>
	</div>
  </div>
</div>
