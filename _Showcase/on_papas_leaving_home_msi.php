...
<title>Now Showcasing: "On Papa's Leaving Home" (MS I)</title>
...
// Select Facsimile 2 //			
$(document).ready(function(){			
	$("#next-1, #navbar-facsimile-2, #last_buton").click(function(){		
		$(".shortcut").css("color", "#FFF");	
...
<div id="navbar-hand" title="Toggle Hands On/Off">
  ...
  <div id="content">
	<div id="content-left">
        <img id="facs_preview" src="../images/_previews/msi/1229146_preview.jpg" width="100%"/>
  	...
  	<div id="content-right">
		<div class="witness">
			<?php include("../witnesses/on_papas_leaving_home_msi.inc.php"); ?>
        </div>
	</div>
  </div>
</div>
